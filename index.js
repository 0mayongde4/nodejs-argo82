...
const SUB_PATH = process.env.SUB_PATH || '4343';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '9396df48-327b-4ce8-9d8f-c243c2a5017c'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'jiakuandingyue';                        // 节点名称
